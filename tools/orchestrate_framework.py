...
def main():
    """
    Função principal para orquestrar execuções do framework investigativo.
    
    Suporta múltiplos modos de operação:
    - grid: Execução com Grid Search tradicional
    - bayes: Execução com Otimização Bayesiana
    - both: Executa ambos os modos sequencialmente
    - post: Apenas pós-processamento de resultados existentes
    
    Returns:
        None
        
    Raises:
        SystemExit: Se houver erro na execução ou argumentos inválidos
    """
