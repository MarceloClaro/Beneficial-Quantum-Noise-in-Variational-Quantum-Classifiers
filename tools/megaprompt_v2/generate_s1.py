...
def write_csv(configurations: List[Dict[str, Any]], output_path: str):
    """
    Escreve configurações experimentais em arquivo CSV.
    
    Args:
        configurations: Lista de dicionários com configurações experimentais
    ...
    Note:
        ...
        O CSV inclui cabeçalho com nomes dos campos.
    """
...
def generate_summary(factors: Dict[str, List[str]], configurations: List[Dict[str, Any]]):
    """
    Imprime sumário detalhado das configurações geradas para Table S1.
    
    Args:
        factors: Dicionário com fatores experimentais e seus níveis
        configurations: Lista de todas as configurações geradas
    
    Returns:
        None
        
    Note:
        Exibe breakdown de fatores, total de configurações e validação do cálculo.
    """
    print("\n" + "="*60)
