...
"""
    ...
    print(f"📐 MathJax habilitado para renderização de LaTeX")
    print(f"\n📄 Para gerar PDF:")
    print(f"   1. O arquivo será aberto no navegador")
    print(f"   2. Aguarde a renderização das equações (2-3 segundos)")
    print(f"   3. Pressione Ctrl+P (Windows) ou Cmd+P (Mac)")
    print(f"   4. Selecione 'Salvar como PDF'")
