"""
Quantum Natural Gradient metric (v10.1-A1)
- Métrica Fubini-Study aproximada com bloco diagonal
"""
...
def qng_metric_block_diag(jacobian: np.ndarray, block_size: int = 2) -> np.ndarray:
    """Computa matriz de métrica block-diagonal a partir de jacobiano."""
