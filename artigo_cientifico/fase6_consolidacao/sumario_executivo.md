...
**Data de Geração**: 2025-12-26 18:57:47


## 📊 Estatísticas do Manuscrito

- **Arquivo Principal**: `manuscrito_internacional_final.md`
- **Total de Palavras**: 22620
- **Total de Linhas**: 2433
- **Seções Incluídas**: 8
- **Modo de Saída**: MODE_A


## 📁 Estrutura do Artigo

1. resumo abstract
2. introducao completa
3. revisao literatura completa
4. metodologia completa
5. resultados completo
6. discussao completa
7. conclusao completa
8. agradecimentos referencias
